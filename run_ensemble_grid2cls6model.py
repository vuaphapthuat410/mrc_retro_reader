...
def main():
    ...
    if args.fin_cof is None:
        ...
        best_score = 0.
        fin_best_cof = None
        for C1 in range(args.start, -1, -5):
                ...
                for C3 in range(0, (100 - C1 - C2) + 1, 5):
                    for C4 in range(0, (100 - C1 - C2 - C3) + 1, 5):
                        for C5 in range(0, (100 - C1 - C2 - C3 - C4) + 1, 5):
                            for C6 in range(0, (100 - C1 - C2 - C3 - C4 - C5) + 1, 5):
                                for C7 in range(0, (100 - C1 - C2 - C3 - C4 - C5 - C6) + 1, 5):
                                    C8 = 100 - C1 - C2 - C3 - C4 - C5 - C6 - C7
                                    c1 = float(C1) / 100.
                                    c2 = float(C2) / 100.
                                    c3 = float(C3) / 100.
                                    c4 = float(C4) / 100.
    ...
    if args.fin_best_cof is None:
        ...
        for C1 in range(args.start_cof, -1, -5):
            for C2 in range(10, (100 - C1) + 1, 5):
                for C3 in range(0, (100 - C2 - C1) + 1, 5):
                    for C4 in range(0, (100 - C2 - C1 - C3) + 1, 5):
                        for C5 in range(0, (100 - C2 - C1 - C3 - C4) + 1, 5):
